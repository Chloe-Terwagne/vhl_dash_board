...
# MAIN ---------------------------------------------------------------------------------------------------------------
# data
df = pd.read_csv("https://github.com/Chloe-Terwagne/vhl_dash_board/blob/main/src/assets/input/vhl_preprocess_df.csv")
...
# 3D parsing & styling
parser = PdbParser('https://github.com/Chloe-Terwagne/vhl_dash_board/blob/main/src/assets/input/3d_structure/1LM8_vhl_isolated.pdb')
